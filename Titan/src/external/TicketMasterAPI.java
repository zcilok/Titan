...
public class TicketMasterAPI implements ExternalAPI {
    ...
    private static final String API_KEY = "jQoWMXrrCInFGHZQDbtQXYsoO9POQRJ5";
    ...
    public List<Item> search(double lat, double lon, String term) {
        ...
        String query = String.format("apikey=%s&geoPoint=%s&radius=50&keyword=%s", API_KEY, geoHash, term);        try {
